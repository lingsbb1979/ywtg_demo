<template>
  ...
  <div class="alarm-dispatch-root" :style="rootStyle">
    <!-- ===== 顶部标题栏 ===== -->
    <header class="alarm-dispatch-header screen-glass-card">
      <div class="alarm-dispatch-header__left">
        <router-link to="/screen/home" class="btn-screen-secondary alarm-dispatch-back">
          ← 返回大屏
        </router-link>
        <h1 class="alarm-dispatch-header__title">告警派遣中心</h1>
      </div>
      ...
      <div class="alarm-dispatch-header__right">
        <span class="alarm-dispatch-time tabular-nums">{{ currentTime }}</span>
      </div>
    </header>
